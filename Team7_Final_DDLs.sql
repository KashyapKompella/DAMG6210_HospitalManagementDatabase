CREATE DATABASE HOSPITAL_MANAGEMENT_V3
USE HOSPITAL_MANAGEMENT_V3
...
/*COLUMN BASED ENCRYPTION FOR ACCESS_ID FIELD*/
...
ALTER TABLE DBO.DOCTOR_LAB_ACCESS
    ADD EncryptedAccessID varbinary(128);   
GO  

SELECT * FROM DOCTOR_LAB_ACCESS

UPDATE DBO.DOCTOR_LAB_ACCESS
SET EncryptedAccessID = EncryptByKey(Key_GUID('GROUP07_Symmetrickey'), ACCESS_ID);  
GO  
